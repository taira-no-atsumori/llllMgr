    ...
    <v-container fluid class="pa-0">
      <v-row no-gutters>
        <v-col cols="12" sm="6">
          <div class="d-flex pr-sm-3 mb-sm-1">
            レアリティ
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('rare');" class="px-2">一括チェック</v-btn>
          </div>
          <v-row no-gutters>
            <v-col
        ...
        <v-col cols="12" sm="6">
          <div class="d-flex mb-1">
            ムード
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('mood');" class="px-2">一括チェック</v-btn>
          </div>
          <v-row no-gutters>
            <v-col
              cols="6"
      ...
      <v-row no-gutters>
        <v-col cols="12" class="d-flex mb-1 mb-sm-0">
          タイプ
          <v-spacer></v-spacer>
          <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('styleType');" class="px-2">一括チェック</v-btn>
        </v-col>
        <v-col
          cols="6"
          sm="2"
      ...
      <v-row no-gutters>
        <v-col cols="12" class="d-flex mb-1">
          メンバー
          <v-spacer></v-spacer>
          <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('memberName');" class="px-2">一括チェック</v-btn>
        </v-col>
        <v-col
          cols="6"
          sm="4"
      ...
      <v-row no-gutters>
        <v-col cols="12" sm="6">
          <div class="d-flex mb-sm-4 pr-sm-3">
            お気に入り
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('favorite');" class="px-2">一括チェック</v-btn>
          </div>
          <v-row no-gutters>
            <v-col
              cols="4"
        ...
        <v-col cols="12" sm="6" class="prl-sm-3 pl-md-3 pl-lg-3 pl-xl-3">
          <div class="d-flex mb-9">
            特訓度
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('trainingLevel');" class="px-2">リセット</v-btn>
          </div>
          <div class="px-1">
            <v-range-slider
              hide-details
      ...
      <v-row no-gutters>
        <v-col cols="12" sm="6" class="pr-sm-3">
          <div class="mb-9 d-flex">
            カードレベル
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('cardLevel');" class="px-2">リセット</v-btn>
          </div>
          <div class="px-1">
            <v-range-slider
              hide-details
        ...
        <v-col cols="12" sm="6" class="prl-sm-3 pl-md-3 pl-lg-3 pl-xl-3">
          <div class="d-flex mb-9">
            解放レベル
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('releaseLevel');" class="px-2">リセット</v-btn>
          </div>
          <div class="px-1">
            <v-range-slider
              hide-details
      ...
      <v-row no-gutters>
        <v-col cols="12" sm="6" class="pr-sm-3">
          <div class="d-flex mb-9">
            スペシャルアピールレベル
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('SALevel');" class="px-2">リセット</v-btn>
          </div>
          <div class="px-1">
            <v-range-slider
              hide-details
        ...
        <v-col cols="12" sm="6" class="prl-sm-3 pl-md-3 pl-lg-3 pl-xl-3">
          <div class="d-flex mb-9">
            スキルレベル
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('SLevel');" class="px-2">リセット</v-btn>
          </div>
          <div class="px-1">
            <v-range-slider
              hide-details
      ...
      <v-row no-gutters>
        <v-col cols="12" sm="6" class="pr-sm-3">
          <div class="d-flex mb-9">
            消費AP(スペシャルアピール)
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('SAAP');" class="px-2">リセット</v-btn>
          </div>
          <div class="px-1">
            <v-range-slider
              hide-details
        ...
        <v-col cols="12" sm="6" class="prl-sm-3 pl-md-3 pl-lg-3 pl-xl-3">
          <div class="d-flex mb-9">
            消費AP(スキル)
            <v-spacer></v-spacer>
            <v-btn density="compact" elevation="1" @click="store.resetMusicFilter('SAP');" class="px-2">リセット</v-btn>
          </div>
          <div class="px-1">
            <v-range-slider
              hide-details
