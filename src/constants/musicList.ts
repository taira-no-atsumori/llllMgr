...
export const MUSIC_LIST = {
  'Dream Believers(4人Ver.)': {
    ...
    level: 1,
    term: 103,
    center: MEMBER_NAMES.KAHO,
    bonusSkill: BONUS_SKILL.LOVE_BONUS,
    singingMembers: [MEMBER_NAMES.KAHO, MEMBER_NAMES.SAYAKA, MEMBER_NAMES.KOZUE, MEMBER_NAMES.TSUZURI],
  },
  '永遠のEuphoria(4人Ver.)': {
    ID: 'm_002',
    musicData: {
  ...
  'ド！ド！ド！': {
    ...
    center: MEMBER_NAMES.RURINO,
    bonusSkill: BONUS_SKILL.BEAT_HEART_UP,
    singingMembers: [MEMBER_NAMES.RURINO, MEMBER_NAMES.MEGUMI],
  },
  ハクチューアラモード: {
    ID: 'm_040',
    musicData: {
  ...
  'ハッピー至上主義！': {
    ...
    center: MEMBER_NAMES.MEGUMI,
    bonusSkill: BONUS_SKILL.MENTAL_RECOVER,
    singingMembers: [MEMBER_NAMES.KAHO, MEMBER_NAMES.MEGUMI],
  },
  'Pleasure Feather': {
    ID: 'm_075',
    musicData: {
    ...
    center: MEMBER_NAMES.SAYAKA,
    bonusSkill: BONUS_SKILL.LOVE_BONUS,
    singingMembers: [MEMBER_NAMES.SAYAKA, MEMBER_NAMES.KOZUE],
  },
  Colorfulness: {
    ID: 'm_076',
    musicData: {
    ...
    center: MEMBER_NAMES.RURINO,
    bonusSkill: BONUS_SKILL.VOLTAGE_UP,
    singingMembers: [MEMBER_NAMES.RURINO, MEMBER_NAMES.TSUZURI],
  },
  Runway: {
    ID: 'm_055',
    musicData: {
    ...
    center: MEMBER_NAMES.SAYAKA,
    bonusSkill: BONUS_SKILL.BEAT_HEART_UP,
    singingMembers: [MEMBER_NAMES.SAYAKA],
  },
  '僕らのLIVE 君とのLIFE': {
    ID: 'm_017',
    musicData: {
  ...
  ビバハピ: {
    ...
    center: MEMBER_NAMES.KAHO,
    bonusSkill: BONUS_SKILL.VOLTAGE_UP,
    singingMembers: [MEMBER_NAMES.KAHO],
    scoreData: {
      difficultyLevel: {
        NORMAL: 11,
        HARD: 18,
  ...
  ロストワンの号哭: {
    ...
    center: MEMBER_NAMES.TSUZURI,
    bonusSkill: BONUS_SKILL.VOLTAGE_UP,
    singingMembers: [MEMBER_NAMES.TSUZURI],
    scoreData: {
      difficultyLevel: {
        NORMAL: 13,
        HARD: 20,
  ...
  '♡桃色片想い♡': {
    ...
    center: MEMBER_NAMES.MEGUMI,
    bonusSkill: BONUS_SKILL.VOLTAGE_UP,
    singingMembers: [MEMBER_NAMES.MEGUMI],
    scoreData: {
      difficultyLevel: {
        NORMAL: 10,
        HARD: 17,
  ...
  ダイヤモンドハッピー: {
    ...
    center: MEMBER_NAMES.KOZUE,
    bonusSkill: BONUS_SKILL.LOVE_BONUS,
    singingMembers: [MEMBER_NAMES.KOZUE, MEMBER_NAMES.TSUZURI, MEMBER_NAMES.MEGUMI],
  },
  'lucky train!': {
    ID: 'm_073',
    musicData: {
    ...
    center: MEMBER_NAMES.SAYAKA,
    bonusSkill: BONUS_SKILL.BEAT_HEART_UP,
    singingMembers: [MEMBER_NAMES.KAHO, MEMBER_NAMES.SAYAKA, MEMBER_NAMES.RURINO],
  },
  ...
  'Reflection in the mirror（104期NEW Ver.）': {
    ...
    center: MEMBER_NAMES.GINKO,
    bonusSkill: BONUS_SKILL.LOVE_BONUS,
    singingMembers: [MEMBER_NAMES.KAHO, MEMBER_NAMES.KOZUE, MEMBER_NAMES.GINKO],
  },
  'Mix shake!!（104期Ver.）': {
    ID: 'm_087',
    musicData: {
  ...
  'Sparkly Spot（104期NEW Ver.）': {
    ...
    bonusSkill: BONUS_SKILL.MENTAL_RECOVER,
    singingMembers: [MEMBER_NAMES.SAYAKA, MEMBER_NAMES.TSUZURI, MEMBER_NAMES.KOSUZU],
  },
  ...
  ルージュの伝言: {
    ...
    center: MEMBER_NAMES.GINKO,
    bonusSkill: BONUS_SKILL.MENTAL_RECOVER,
    singingMembers: [MEMBER_NAMES.GINKO],
  },
  ビビデバ: {
    ID: 'm_121',
    musicData: {
    ...
    center: MEMBER_NAMES.KOSUZU,
    bonusSkill: BONUS_SKILL.VOLTAGE_UP,
    singingMembers: [MEMBER_NAMES.KOSUZU],
  },
  'This game': {
    ID: 'm_124',
    musicData: {
    ...
    center: MEMBER_NAMES.HIME,
    bonusSkill: BONUS_SKILL.MENTAL_RECOVER,
    singingMembers: [MEMBER_NAMES.HIME],
  },
  STARTLINER: {
    ID: 'm_132',
    musicData: {
  ...
  恥は人生のかきすて: {
    ...
    center: MEMBER_NAMES.KOSUZU,
    bonusSkill: BONUS_SKILL.MENTAL_RECOVER,
    singingMembers: [MEMBER_NAMES.GINKO, MEMBER_NAMES.KOSUZU, MEMBER_NAMES.HIME],
  },
  ...
  'Celebration!': {
    ...
    center: MEMBER_NAMES.KAHO,
    bonusSkill: BONUS_SKILL.VOLTAGE_UP,
    singingMembers: [MEMBER_NAMES.KAHO, MEMBER_NAMES.GINKO],
    scoreData: {
      difficultyLevel: {
        NORMAL: 14,
        HARD: 17,
  ...
  'WAWO！': {
    ...
    center: MEMBER_NAMES.RURINO,
    bonusSkill: BONUS_SKILL.LOVE_BONUS,
    singingMembers: [MEMBER_NAMES.RURINO, MEMBER_NAMES.HIME],
    scoreData: {
      difficultyLevel: {
        NORMAL: 14,
        HARD: 19,
  ...
  ロミオとシンデレラ: {
    ...
    center: MEMBER_NAMES.SERAS,
    bonusSkill: BONUS_SKILL.LOVE_BONUS,
    singingMembers: [MEMBER_NAMES.SERAS],
    scoreData: {
      difficultyLevel: {
        NORMAL: 14,
        HARD: 21,
  ...
  月光: {
    ...
    center: MEMBER_NAMES.IZUMI,
    bonusSkill: BONUS_SKILL.LOVE_BONUS,
    singingMembers: [MEMBER_NAMES.IZUMI],
    scoreData: {
      difficultyLevel: {
        NORMAL: 10,
        HARD: 17,
